...
// GENERAL STATS
// ICON disabled, as not supported by OT.
...
// As far as possible, every statistic in its name and in its description, is faithful to what is reported in PT that now is 100% supported
...
#define OT_QUERY_SUPPORT__PFR							(TRUE)	// "pfr"
#define OT_QUERY_SUPPORT__VPIP							(TRUE)	// "vpip"
#define OT_QUERY_SUPPORT__ICON							(FALSE) // "icon"
#define OT_QUERY_SUPPORT__NB_HANDS					(TRUE)	// "hands"
#define OT_QUERY_SUPPORT__VPIP_LEGACY			(TRUE)	// "vpip (old way)"
#define OT_QUERY_SUPPORT__PFR_LEGACY				(TRUE)	// "pfr (old way)"
#define OT_QUERY_SUPPORT__RFI							(TRUE)	// "rfi"
#define OT_QUERY_SUPPORT__WTSD							(TRUE)	// "wtsd"
#define OT_QUERY_SUPPORT__WSSD							(TRUE)	// "wssd"

// PREFLOP STATS
#define OT_QUERY_SUPPORT__STEAL_ATTEMPT				  (TRUE)	// "steal_attempt"
#define OT_QUERY_SUPPORT__FOLD_BB_TO_STEAL				(TRUE)	// "bb_fold_to_steal"
#define OT_QUERY_SUPPORT__FOLD_SB_TO_STEAL				(TRUE)	// "sb_fold_to_steal"
#define OT_QUERY_SUPPORT__3B_VS_STEAL					  (TRUE)	// "3bet_vs_steal"
#define OT_QUERY_SUPPORT__BB_3B_VS_STEAL				  (TRUE)	// "bb_3bet_vs_steal"
#define OT_QUERY_SUPPORT__SB_3B_VS_STEAL				  (TRUE)	// "sb_3bet_vs_steal"
#define OT_QUERY_SUPPORT__PREFLOP_CALLED_RAISE		(TRUE)	// "preflop_called_raise"
#define OT_QUERY_SUPPORT__PREFLOP_3B					    (TRUE)	// "3bet"
#define OT_QUERY_SUPPORT__PREFLOP_FOLD_TO_3B			(TRUE)	// "fold_to_3bet"
#define OT_QUERY_SUPPORT__PREFLOP_FOLD_TO_3B_AFTER_RAISE			(TRUE)	// "fold_to_3bet"
#define OT_QUERY_SUPPORT__PF_FOLD_TO_RESTEAL			(TRUE)	// "fold_to_resteal"
#define OT_QUERY_SUPPORT__PREFLOP_4B					    (TRUE)	// "4bet"
#define OT_QUERY_SUPPORT__PREFLOP_FOLD_TO_4B			(TRUE)	// "fold_to_4bet"
#define OT_QUERY_SUPPORT__4BET_PLUS_RATIO     		(TRUE)	// ""
#define OT_QUERY_SUPPORT__FOLD_TO_PF_SQUEEZE     (TRUE)	// ""
#define OT_QUERY_SUPPORT__FOLD_TO_SQUEEZE_AS_RAISER  		(TRUE)	// ""
#define OT_QUERY_SUPPORT__FOLD_TO_SQUEEZE_AS_CALLER  		(TRUE)	// ""
#define OT_QUERY_SUPPORT__PREFLOP_SQUEEZE     		(TRUE)	// ""
#define OT_QUERY_SUPPORT__FOLD_TO_PF_4BET_AFTER_3BET     (TRUE)	// ""

// AF
#define OT_QUERY_SUPPORT__FLOP_AGGRESSION_FACTOR		(TRUE)	// "flop_af"
#define OT_QUERY_SUPPORT__TURN_AGGRESSION_FACTOR		(TRUE)	// "turn_af"
#define OT_QUERY_SUPPORT__RIVER_AGGRESSION_FACTOR	(TRUE)	// "river_af"
#define OT_QUERY_SUPPORT__TOTAL_AGGRESSION_FACTOR	(TRUE)	// "total_af"

// AFq
#define OT_QUERY_SUPPORT__FLOP_AGGRESSION_FREQUENCY	(TRUE)	// "flop_afq" 
#define OT_QUERY_SUPPORT__TURN_AGGRESSION_FREQUENCY	(TRUE)	// "turn_afq" 
#define OT_QUERY_SUPPORT__RIVER_AGGRESSION_FREQUENCY	(TRUE)	// "river_afq" 
#define OT_QUERY_SUPPORT__TOTAL_AGGRESSION_FREQUENCY	(TRUE)	// "total_afq" 

// Street seen
#define OT_QUERY_SUPPORT__SEEN_FLOP_PCT			  	(TRUE)	// "flop_seen"
#define OT_QUERY_SUPPORT__SEEN_TURN_PCT			  	(TRUE)	// "turn_seen"
#define OT_QUERY_SUPPORT__SEEN_RIVER_PCT			  	(TRUE)	// "river_seen"

// Continuation bet // not filtred /// action for all type of pre flop game /// AKA SRP 3BET AND 3BET+
// Flop
#define OT_QUERY_SUPPORT__FLOP_CBET					  (TRUE)	// "flop_cbet"
#define OT_QUERY_SUPPORT__FLOP_FOLD_TO_CBET	  (TRUE)	// "flop_fold_to_cbet"
#define OT_QUERY_SUPPORT__FLOP_RAISE_CBET		  (TRUE)	// "flop_raise_cbet"
// Turn
#define OT_QUERY_SUPPORT__TURN_CBET					  (TRUE)	// "turn_cbet"
#define OT_QUERY_SUPPORT__TURN_FOLD_TO_CBET	  (TRUE)	// "turn_fold_to_cbet"
// River
#define OT_QUERY_SUPPORT__RIVER_FOLD_TO_CBET	  (TRUE)	// "river_fold_to_cbet"

// POSTFLOP Other stats
#define OT_QUERY_SUPPORT__POSTFLOP_FOLD_TO_3B	(TRUE)	// "postflop_fold_to_3bet"

// FLOP Other stats
#define OT_QUERY_SUPPORT__FLOP_FOLD_TO_3B			(FALSE)	// "flop_fold_to_3bet"   // 3b is a reraise, we should have a "flop_fold_to_raise" stat first.
#define OT_QUERY_SUPPORT__FLOP_CHECK_RAISE			(TRUE)	// "flop_checkraise"
#define OT_QUERY_SUPPORT__FLOP_DONKBET					(TRUE)	// "flop_donkbet"
#define OT_QUERY_SUPPORT__FLOP_FLOAT     			(TRUE)	// "flop_float" (PT's stat for: bet IP flop vs missed cbet)
#define OT_QUERY_SUPPORT__FOLD_TO_F_CHECK_RAISE     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FLOAT_FLOP     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__CALL_F_FLOAT_BET     				(TRUE)	// ""

// TURN Other stats
#define OT_QUERY_SUPPORT__TURN_FOLD_TO_3B			(FALSE)	// "turn_fold_to_3bet" // 3b is a reraise, we should have a "turn_fold_to_raise" stat first.
#define OT_QUERY_SUPPORT__TURN_CHECK_RAISE			(TRUE)	// "turn_checkraise"
#define OT_QUERY_SUPPORT__TURN_CHECK_CALL			(TRUE)	// "turn_checkcall"

// RIVER Other stats
#define OT_QUERY_SUPPORT__RIVER_FOLD_TO_3B			(FALSE)	// "river_fold_to_3bet" // 3b is a reraise, we should have a "river_fold_to_raise" stat first.
#define OT_QUERY_SUPPORT__RIVER_BET     				(TRUE)	// "river_bet"

// FLOP - 3BET Pots AND 3BET + Pots
#define OT_QUERY_SUPPORT__DONK_FLOP_IN_3BET_PLUS_POT     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FOLD_TO_F_CBET_IN_3BET_POT     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__CBET_FLOP_IN_3BET_POT     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FLOP_CHECK_RAISE_IN_3BET_POT     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FLOP_CHECK_RAISE_IN_3BET_PLUS_POT     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FOLD_TO_F_CHECK_RAISE_3B_PLUS_POT     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FLOAT_FLOP_IN_3BET_POT     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__CALL_F_FLOAT_BET_IN_3B_POT     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FOLD_TO_F_FLOAT_BET_IN_3B_POT     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FOLD_TO_F_FLOAT_BET_IN_3B_PLUS_POT     				(TRUE)	// ""

// Advanced RFI - Positional Pre Flop - 6 MAX AND 9 MAX now supported
#define OT_QUERY_SUPPORT__RFI_BTN_6MAX     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__RFI_CO_6MAX     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__RFI_MP_6MAX     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__RFI_EP_6MAX     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__RFI_SB_6MAX     				(TRUE)	// ""

#define OT_QUERY_SUPPORT__RFI_BTN_9MAX     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__RFI_CO_9MAX     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__RFI_MP_9MAX     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__RFI_MP1_9MAX     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__RFI_MP2_9MAX     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__RFI_EP_9MAX     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__RFI_EP1_9MAX     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__RFI_SB_9MAX     				(TRUE)	// ""

// Advanced OPPORTUNITIES /// 
#define OT_QUERY_SUPPORT__CBET_FLOP_OPP_IN_3BET_POT     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__CBET_FLOP_OPP     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FOLD_TO_3BET_AFTER_R_OPP     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__PREFLOP_SQUEEZE_OPP   				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FLOP_FOLD_TO_CBET__FLOP_RAISE_CBET_OPP     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FLOP_DONKBET_OPP    				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FOLD_TO_F_CBET_IN_3BET_PLUS_POT_OPP     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FOLD_TO_F_CHECK_RAISE_OPP     				(TRUE)	// ""
#define OT_QUERY_SUPPORT__FOLD_TO_SQUEEZE_AS_RAISER_OPP     				(TRUE)	// ""

const int k_number_of_opentracker_stats =  //GENERAL STATS
(OT_QUERY_SUPPORT__ICON ? 1 : 0)
+ (OT_QUERY_SUPPORT__NB_HANDS ? 1 : 0)
+ (OT_QUERY_SUPPORT__PFR ? 1 : 0)
+ (OT_QUERY_SUPPORT__VPIP ? 1 : 0)
+ (OT_QUERY_SUPPORT__VPIP_LEGACY ? 1 : 0)
+ (OT_QUERY_SUPPORT__PFR_LEGACY ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI ? 1 : 0)
+ (OT_QUERY_SUPPORT__WTSD ? 1 : 0)
+ (OT_QUERY_SUPPORT__WSSD ? 1 : 0)
//PREFLOP STATS
+ (OT_QUERY_SUPPORT__STEAL_ATTEMPT ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_BB_TO_STEAL ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_SB_TO_STEAL ? 1 : 0)
+ (OT_QUERY_SUPPORT__3B_VS_STEAL ? 1 : 0)
+ (OT_QUERY_SUPPORT__BB_3B_VS_STEAL ? 1 : 0)
+ (OT_QUERY_SUPPORT__SB_3B_VS_STEAL ? 1 : 0)
+ (OT_QUERY_SUPPORT__PREFLOP_CALLED_RAISE ? 1 : 0)
+ (OT_QUERY_SUPPORT__PREFLOP_3B ? 1 : 0)
+ (OT_QUERY_SUPPORT__PREFLOP_FOLD_TO_3B ? 1 : 0)
+ (OT_QUERY_SUPPORT__PREFLOP_FOLD_TO_3B_AFTER_RAISE ? 1 : 0)
+ (OT_QUERY_SUPPORT__PF_FOLD_TO_RESTEAL ? 1 : 0)
+ (OT_QUERY_SUPPORT__PREFLOP_4B ? 1 : 0)
+ (OT_QUERY_SUPPORT__PREFLOP_FOLD_TO_4B ? 1 : 0)
//  AF
+ (OT_QUERY_SUPPORT__FLOP_AGGRESSION_FACTOR ? 1 : 0)
+ (OT_QUERY_SUPPORT__TURN_AGGRESSION_FACTOR ? 1 : 0)
+ (OT_QUERY_SUPPORT__RIVER_AGGRESSION_FACTOR ? 1 : 0)
+ (OT_QUERY_SUPPORT__TOTAL_AGGRESSION_FACTOR ? 1 : 0)
//  AFq
+ (OT_QUERY_SUPPORT__FLOP_AGGRESSION_FREQUENCY ? 1 : 0)
+ (OT_QUERY_SUPPORT__TURN_AGGRESSION_FREQUENCY ? 1 : 0)
+ (OT_QUERY_SUPPORT__RIVER_AGGRESSION_FREQUENCY ? 1 : 0)
+ (OT_QUERY_SUPPORT__TOTAL_AGGRESSION_FREQUENCY ? 1 : 0)
// POSTFLOP stats
+ (OT_QUERY_SUPPORT__POSTFLOP_FOLD_TO_3B ? 1 : 0)
//  Street seen
+ (OT_QUERY_SUPPORT__SEEN_FLOP_PCT ? 1 : 0)
+ (OT_QUERY_SUPPORT__SEEN_TURN_PCT ? 1 : 0)
+ (OT_QUERY_SUPPORT__SEEN_RIVER_PCT ? 1 : 0)
//  Continuation bet
//  Flop
+ (OT_QUERY_SUPPORT__FLOP_CBET ? 1 : 0)
+ (OT_QUERY_SUPPORT__FLOP_FOLD_TO_CBET ? 1 : 0)
+ (OT_QUERY_SUPPORT__FLOP_RAISE_CBET ? 1 : 0)
//  Turn
+ (OT_QUERY_SUPPORT__TURN_CBET ? 1 : 0)
+ (OT_QUERY_SUPPORT__TURN_FOLD_TO_CBET ? 1 : 0)
//  River
+ (OT_QUERY_SUPPORT__RIVER_FOLD_TO_CBET ? 1 : 0)
//  Flop Other stats
+ (OT_QUERY_SUPPORT__FLOP_FOLD_TO_3B ? 1 : 0)
+ (OT_QUERY_SUPPORT__FLOP_CHECK_RAISE ? 1 : 0)
+ (OT_QUERY_SUPPORT__FLOP_DONKBET ? 1 : 0)
+ (OT_QUERY_SUPPORT__FLOP_FLOAT ? 1 : 0)
//  Turn Other stats
+ (OT_QUERY_SUPPORT__TURN_FOLD_TO_3B ? 1 : 0)
+ (OT_QUERY_SUPPORT__TURN_CHECK_RAISE ? 1 : 0)
+ (OT_QUERY_SUPPORT__TURN_CHECK_CALL ? 1 : 0)
//  River Other stats
+ (OT_QUERY_SUPPORT__RIVER_FOLD_TO_3B ? 1 : 0)
+ (OT_QUERY_SUPPORT__RIVER_BET ? 1 : 0)
//  Varie
+ (OT_QUERY_SUPPORT__4BET_PLUS_RATIO ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_TO_PF_SQUEEZE ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_TO_SQUEEZE_AS_RAISER ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_TO_SQUEEZE_AS_CALLER ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_TO_F_CHECK_RAISE ? 1 : 0)
+ (OT_QUERY_SUPPORT__FLOAT_FLOP ? 1 : 0)
+ (OT_QUERY_SUPPORT__CALL_F_FLOAT_BET ? 1 : 0)
+ (OT_QUERY_SUPPORT__PREFLOP_SQUEEZE ? 1 : 0)
//  3bet and 3bet+
+ (OT_QUERY_SUPPORT__DONK_FLOP_IN_3BET_PLUS_POT ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_TO_F_CBET_IN_3BET_POT ? 1 : 0)
+ (OT_QUERY_SUPPORT__CBET_FLOP_IN_3BET_POT ? 1 : 0)
+ (OT_QUERY_SUPPORT__FLOP_CHECK_RAISE_IN_3BET_POT ? 1 : 0)
+ (OT_QUERY_SUPPORT__FLOP_CHECK_RAISE_IN_3BET_PLUS_POT ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_TO_F_CHECK_RAISE_3B_PLUS_POT ? 1 : 0)
+ (OT_QUERY_SUPPORT__FLOAT_FLOP_IN_3BET_POT ? 1 : 0)
+ (OT_QUERY_SUPPORT__CALL_F_FLOAT_BET_IN_3B_POT ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_TO_F_FLOAT_BET_IN_3B_POT ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_TO_F_FLOAT_BET_IN_3B_PLUS_POT ? 1 : 0)
//	Positional	
+ (OT_QUERY_SUPPORT__RFI_BTN_6MAX ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI_CO_6MAX ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI_MP_6MAX ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI_EP_6MAX ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI_SB_6MAX ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI_BTN_9MAX ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI_CO_9MAX ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI_MP_9MAX ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI_MP1_9MAX ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI_MP2_9MAX ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI_EP_9MAX ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI_EP1_9MAX ? 1 : 0)
+ (OT_QUERY_SUPPORT__RFI_SB_9MAX ? 1 : 0)
// OPP
+ (OT_QUERY_SUPPORT__CBET_FLOP_OPP_IN_3BET_POT ? 1 : 0)
+ (OT_QUERY_SUPPORT__CBET_FLOP_OPP ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_TO_3BET_AFTER_R_OPP ? 1 : 0)
+ (OT_QUERY_SUPPORT__PREFLOP_SQUEEZE_OPP ? 1 : 0)
+ (OT_QUERY_SUPPORT__FLOP_FOLD_TO_CBET__FLOP_RAISE_CBET_OPP ? 1 : 0)
+ (OT_QUERY_SUPPORT__FLOP_DONKBET_OPP ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_TO_F_CBET_IN_3BET_PLUS_POT_OPP ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_TO_F_CHECK_RAISE_OPP ? 1 : 0)
+ (OT_QUERY_SUPPORT__FOLD_TO_SQUEEZE_AS_RAISER_OPP ? 1 : 0);

// OpenTracker support
enum OT_Groups {
	ot_group_basic = 1,
	ot_group_advanced = 2,
	ot_group_positional = 3
};

enum OT_UpdateTypes {
	ot_updateType_noUpdate = 0,
	ot_updateType_updateBasic = 1,
	ot_updateType_updateAll = 2
};

enum OT_StatTypes {
	ot_statType_Ring = 0,
	ot_statType_Tourney = 1
};

struct t_StatQueryDefinition {
	CString name;
...
enum {
	...
	k_number_of_dbmanagement_queries,
};

t_DBQueryDefinition db_query_definitions[k_number_of_dbmanagement_queries] =
{
	{
		// name
		"drop_db",
...
t_StatQueryDefinition stat_query_definitions[k_number_of_opentracker_stats] =
{
#if OT_QUERY_SUPPORT__ICON
	// OT query to get icon 
	{
		// name
		"icon",
		// description_for_editor
		"Open Tracker auto-rate icon code",
		// query
...
#if OT_QUERY_SUPPORT__VPIP 
	// OT query to get vpip 
	{
		// name
		"vpip",
		// description_for_editor
...
#if OT_QUERY_SUPPORT__NB_HANDS
	// OT query to get number of hands in the database 
	{
		// name
		"hands",
		// description_for_editor
		"Open Tracker number of hands that are in the database",
		// query
...
#if OT_QUERY_SUPPORT__VPIP_LEGACY
	// OT query to get vpip 
	{
		// name
		"vpip_L",
		// description_for_editor
		"Open Tracker VP$IP Legacy Edition",
		// query
		"SELECT (case	when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__PFR_LEGACY
	// OT query to get pre flop raise 
	{
		// name
		"pfr_L",
		// description_for_editor
		"Open Tracker pre-flop raise Legacy Edition",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__RFI
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi",
		// description_for_editor
		"Open Tracker pre-flop raise first in",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__RFI_BTN_6MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_btn_6max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position BTN _6max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__RFI_CO_6MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_co_6max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position CO _6max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__RFI_MP_6MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_mp_6max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position MP _6max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__RFI_EP_6MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_ep_6max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position EP _6max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__RFI_SB_6MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_sb_6max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position SB _6max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__RFI_BTN_9MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_btn_9max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position BTN _9max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__RFI_CO_9MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_co_9max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position CO _9max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__RFI_MP2_9MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_mp2_9max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position MP2 _9max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__RFI_MP1_9MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_mp1_9max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position MP1 _9max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__RFI_MP_9MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_mp_9max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position MP _9max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__RFI_EP1_9MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_ep1_9max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position EP1 _9max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__RFI_EP_9MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_ep_9max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position EP _9max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__RFI_SB_9MAX
	// OT query to get pre-flop raise first in
	{
		// name
		"rfi_sb_9max",
		// description_for_editor
		"Open Tracker pre-flop raise first in - Position SB _9max",
		// query
		"SELECT(case when ActionOpportunities = 0 then - 1 \
			 else cast(ActionCount as real) / ActionOpportunities \
			      end) as result \
...
#if OT_QUERY_SUPPORT__WTSD
	// OT query to get Went to SD 
	{
		// name
		"wtsd",
		// description_for_editor
		"Open Tracker went to showdown",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__WSSD
	// OT query to get Won $ At SD 
	{
		// name
		"wssd",
		// description_for_editor
		"Open Tracker won $ at showdown",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__STEAL_ATTEMPT
	// OT query to get attempted to steal 
	{
		// name
		"steal_attempt",
		// description_for_editor
		"Open Tracker attempt to steal blinds",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__FOLD_BB_TO_STEAL
	// OT query to get Folded Big Blind to steal 
	{
		// name
		"bb_fold_to_steal",
		// description_for_editor
		"Open Tracker folded big blind to steal",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__FOLD_SB_TO_STEAL
	// OT query to get Folded Small Blind to steal 
	{
		// name
		"sb_fold_to_steal",
		// description_for_editor
		"Open Tracker folded small blind to steal",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__3B_VS_STEAL
	// OT query to get 3B vs. steal 
	{
		// name
		"3bet_vs_steal",
		// description_for_editor
		"Open Tracker 3bet vs. steal",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__BB_3B_VS_STEAL
	// OT query to get BB 3B vs. steal 
	{
		// name
		"bb_3bet_vs_steal",
		// description_for_editor
		"Open Tracker BB 3bet vs. steal",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
      else cast(ActionCount as real) / ActionOpportunities \
      end) as result \
...
#if OT_QUERY_SUPPORT__SB_3B_VS_STEAL
	// OT query to get SB 3B vs. steal 
	{
		// name
		"sb_3bet_vs_steal",
		// description_for_editor
		"Open Tracker SB 3bet vs. steal",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
      else cast(ActionCount as real) / ActionOpportunities \
      end) as result \
...
#if OT_QUERY_SUPPORT__PREFLOP_CALLED_RAISE
	// OT query to get pre-flop called raise 
	{
		// name
		"preflop_called_raise",
		// description_for_editor
		"Open Tracker pre-flop called raise",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__PREFLOP_3B
	// OT  query to get PREFLOP 3 bet 
	{
		// name
		"3bet",
		// description_for_editor
		"Open Tracker 3bet preflop",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__PREFLOP_FOLD_TO_3B
	// OT  query to get PREFLOP fold to 3 bet 
	{
		// name
		"fold_to_3bet",
		// description_for_editor
		"Open Tracker folded while facing 3bet preflop",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__PREFLOP_FOLD_TO_3B_AFTER_RAISE
	// OT  query to get PREFLOP fold to 3 bet 
	{
		// name
		"fold_to_3bet_afterR",
		// description_for_editor
		"Open Tracker folded while facing 3bet preflop ... after raise",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__PF_FOLD_TO_RESTEAL
	// OT query to get Fold to Resteal 
	{
		// name
		"fold_to_resteal",
		// description_for_editor
		"Open Tracker Fold to 3bet after Stealing",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__PREFLOP_4B
	// OT query to get Preflop 4B 
	{
		// name
		"4bet",
		// description_for_editor
		"Open Tracker Preflop 4B",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__PREFLOP_FOLD_TO_4B
	// OT query to get Preflop fold to 4B 
	{
		// name
		"fold_to_4bet",
		// description_for_editor
		"Open Tracker Preflop fold to 4bet",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__PREFLOP_SQUEEZE
	// OT 
	{
		// name
		"preflop_squeeze",
...
#if OT_QUERY_SUPPORT__FLOP_AGGRESSION_FACTOR
	// OT query to get flop aggression factor 
	{
		// name
		"flop_af",
		// description_for_editor
		"Open Tracker flop aggression",
		// query
...
#if OT_QUERY_SUPPORT__TURN_AGGRESSION_FACTOR
	// OT query to get turn aggression factor 
	{
		// name
		"turn_af",
		// description_for_editor
		"Open Tracker turn aggression",
		// query
		"SELECT (case when CallsCount = 0 then -1 \
				 else cast(AggressionCount as real) / CallsCount \
				 end) as result \
...
#if OT_QUERY_SUPPORT__RIVER_AGGRESSION_FACTOR
	// OT query to get river aggression factor 
	{
		// name
		"river_af",
		// description_for_editor
		"Open Tracker river aggression",
		// query
		"SELECT (case when CallsCount = 0 then -1 \
				 else cast(AggressionCount as real) / CallsCount \
				 end) as result \
...
#if OT_QUERY_SUPPORT__TOTAL_AGGRESSION_FACTOR
	// OT query to get total aggression factor without preflop 
	{
		// name
		"total_af",
		// description_for_editor
		"Open Tracker total aggression excluding preflop",
		// query
		"SELECT (case when CallsCount = 0 then -1 \
				else cast(AggressionCount as real) / CallsCount \
				end) as result \
...
#if OT_QUERY_SUPPORT__FLOP_AGGRESSION_FREQUENCY
	// OT query to get flop aggression frequency 
	{
		// name
		"flop_afq",
		// description_for_editor
		"Open Tracker flop aggression frequency",
		// query
...
#if OT_QUERY_SUPPORT__TURN_AGGRESSION_FREQUENCY
	// OT query to get turn aggression frequency 
	{
		// name
		"turn_afq",
		// description_for_editor
		"Open Tracker turn aggression frequency",
		// query
		"SELECT (case when (AggressionCount + PassiveCount) = 0 then -1 \
				else cast(AggressionCount as real) / (AggressionCount + PassiveCount) \
				end) as result \
...
#if OT_QUERY_SUPPORT__RIVER_AGGRESSION_FREQUENCY
	// OT query to get river aggression frequency 
	{
		// name
		"river_afq",
		// description_for_editor
		"Open Tracker river aggression frequency",
		// query
		"SELECT (case when (AggressionCount + PassiveCount) = 0 then -1 \
				else cast(AggressionCount as real) / (AggressionCount + PassiveCount) \
				end) as result \
...
#if OT_QUERY_SUPPORT__TOTAL_AGGRESSION_FREQUENCY
	// OT query to get total aggression frequency without preflop 
	{
		// name
		"total_afq",
		// description_for_editor
		"Open Tracker total aggression frequency excluding preflop",
...
#if OT_QUERY_SUPPORT__SEEN_FLOP_PCT
	// OT query to get flops seen 
	{
		// name
		"flop_seen",
		// description_for_editor
		"Open Tracker saw flop",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__SEEN_TURN_PCT
	// OT query to get turns seen 
	{
		// name
		"turn_seen",
		// description_for_editor
		"Open Tracker saw turn",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__SEEN_RIVER_PCT
	// OT query to get rivers seen 
	{
		// name
		"river_seen",
		// description_for_editor
		"Open Tracker saw river",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__FLOP_CBET
	// OT  query to get cbet on FLOP 
	{
		// name
		"flop_cbet",
		// description_for_editor
...
#if OT_QUERY_SUPPORT__FLOP_FOLD_TO_CBET
	// OT  query to get FLOP fold to cbet 
	{
		// name
		"flop_fold_to_cbet",
		// description_for_editor
		"Open Tracker folded while facing cbet flop",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__FLOP_RAISE_CBET
	// OT  query to get raise cbet on FLOP 
	{
		// name
		"flop_raise_cbet",
		// description_for_editor
		"Open Tracker raise flop cbet",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__TURN_CBET
	// OT  query to get cbet on TURN 
	{
		// name
		"turn_cbet",
		// description_for_editor
		"Open Tracker turn cbet",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__TURN_FOLD_TO_CBET
	// OT  query to get TURN fold to cbet 
	{
		// name
		"turn_fold_to_cbet",
		// description_for_editor
		"Open Tracker folded while facing cbet turn",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__RIVER_FOLD_TO_CBET
	// OT  query to get RIVER fold to cbet 
	{
		// name
		"river_fold_to_cbet",
		// description_for_editor
		"Open Tracker folded while facing cbet river",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__POSTFLOP_FOLD_TO_3B
	// OT  query to get total fold to 3 bet without preflop
	{
		// name
		"postflop_fold_to_3bet",
		// description_for_editor
		"Open Tracker folded while facing 3bet total without preflop",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__FLOP_FOLD_TO_3B
	// OT  query to get FLOP fold to 3 bet 
	{
		// name
		"flop_fold_to_3bet",
		// description_for_editor
		"Open Tracker folded while facing 3bet flop",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__FLOP_CHECK_RAISE
	// OT  query to get flop check-raise 
	{
		// name
		"flop_checkraise",
		// description_for_editor
		"Open Tracker flop check-raise",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__FLOP_DONKBET
	// OT  query to get FLOP donk 
	{
		// name
		"flop_donkbet",
		// description_for_editor
		"Open Tracker donk flop",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__FLOP_FLOAT
	// OT  query to get flop float 
	{
		// name
		"flop_float",
		// description_for_editor
		"Open Tracker flop float",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__TURN_FOLD_TO_3B
	// OT  query to get TURN fold to 3 bet 
	{
		// name
		"turn_fold_to_3bet",
		// description_for_editor
		"Open Tracker folded while facing 3bet turn",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__TURN_CHECK_RAISE
	// OT  query to get TURN Check-Raise 
	{
		// name
		"turn_checkraise",
		// description_for_editor
		"Open Tracker turn Check-Raise",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__TURN_CHECK_CALL
	// OT  query to get TURN Check-Call 
	{
		// name
		"turn_checkcall",
		// description_for_editor
		"Open Tracker turn Check-Call",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__RIVER_FOLD_TO_3B
	// OT  query to get RIVER fold to 3 bet 
	{
		// name
		"river_fold_to_3bet",
		// description_for_editor
		"Open Tracker folded while facing 3bet river",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__RIVER_BET
	// OT  query to get River bet 
	{
		// name
		"river_bet",
		// description_for_editor
		"Open Tracker river bet",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__4BET_PLUS_RATIO
	// OT 
	{
		// name
		"4bet_plus_ratio",
		// description_for_editor
		"Open Tracker 4bet + ratio",
		// query
...
#if OT_QUERY_SUPPORT__FOLD_TO_PF_SQUEEZE
	// OT 
	{
		// name
		"fold_to_pf_squeeze",
		// description_for_editor
		"Open Tracker fold to pf squeeze",
		// query
...
#if OT_QUERY_SUPPORT__FOLD_TO_SQUEEZE_AS_RAISER
	// OT 
	{
		// name
		"fold_to_squeeze_as_raiser",
		// description_for_editor
		"Open Tracker fold to squeeze as raiser",
		// query
...
#if OT_QUERY_SUPPORT__FOLD_TO_SQUEEZE_AS_CALLER
	// OT 
	{
		// name
		"fold_to_squeeze_as_caller",
		// description_for_editor
		"Open Tracker fold to squeeze as caller",
		// query
...
#if OT_QUERY_SUPPORT__DONK_FLOP_IN_3BET_PLUS_POT
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__FOLD_TO_F_CBET_IN_3BET_POT
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__CBET_FLOP_IN_3BET_POT
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__FLOP_CHECK_RAISE_IN_3BET_POT
	// OT 
	{
		// name
		"flop_check_raise_in_3bet_pot",
		// description_for_editor
		"Open Tracker flop check-raise in 3Bet Pot %",
		// query
		"SELECT (case when ActionOpportunities = 0 then -1 \
				 else cast(ActionCount as real) / ActionOpportunities \
				 end) as result \
...
#if OT_QUERY_SUPPORT__FLOP_CHECK_RAISE_IN_3BET_PLUS_POT
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__FOLD_TO_F_CHECK_RAISE
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__FOLD_TO_F_CHECK_RAISE_3B_PLUS_POT
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__FLOAT_FLOP
	// OT 
	{
		// name
		"float_flop",
...
#if OT_QUERY_SUPPORT__FLOAT_FLOP_IN_3BET_POT
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__CALL_F_FLOAT_BET
	// OT 
	{
		// name
		"call_f_float_bet",
...
#if OT_QUERY_SUPPORT__CALL_F_FLOAT_BET_IN_3B_POT
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__FOLD_TO_F_FLOAT_BET_IN_3B_POT
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__FOLD_TO_F_FLOAT_BET_IN_3B_PLUS_POT
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__CBET_FLOP_OPP_IN_3BET_POT
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__CBET_FLOP_OPP
	// OT 
	{
		// name
		"cbet_flop_opp",
...
#if OT_QUERY_SUPPORT__FOLD_TO_3BET_AFTER_R_OPP
	// OT 
	{
		// name
		"fold_to_3bet_afterR_opp",
		// description_for_editor
		"Open Tracker folded while facing 3bet preflop Opportunities after raise",
		// query
...
#if OT_QUERY_SUPPORT__PREFLOP_SQUEEZE_OPP
	// OT 
	{
		// name
		"preflop_squeeze_opp",
...
#if OT_QUERY_SUPPORT__FLOP_FOLD_TO_CBET__FLOP_RAISE_CBET_OPP
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__FLOP_DONKBET_OPP
	// OT 
	{
		// name
		"flop_donkbet_opp",
		// description_for_editor
		"Open Tracker donk flop Opportunities",
		// query
...
#if OT_QUERY_SUPPORT__FOLD_TO_F_CBET_IN_3BET_PLUS_POT_OPP
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__FOLD_TO_F_CHECK_RAISE_OPP
	// OT 
	{
		// name
...
#if OT_QUERY_SUPPORT__FOLD_TO_SQUEEZE_AS_RAISER_OPP
	// OT 
	{
		// name

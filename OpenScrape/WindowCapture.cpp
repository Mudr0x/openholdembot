...
WindowCapture::WindowCapture(winrt::IDirect3DDevice const& device, winrt::GraphicsCaptureItem const& item, winrt::DirectXPixelFormat pixelFormat)
{
    m_item = item;
    m_device = device;
...
winrt::ICompositionSurface WindowCapture::CreateSurface(winrt::Compositor const& compositor)
{
    CheckClosed();
...
void WindowCapture::ResizeSwapChain()
{
...
bool WindowCapture::TryResizeSwapChain(winrt::Direct3D11CaptureFrame const& frame)
{
...
bool WindowCapture::TryUpdatePixelFormat()
{
